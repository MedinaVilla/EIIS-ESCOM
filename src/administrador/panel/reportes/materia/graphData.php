<?php 
    if(isset($_POST)){    
        ...
        INNER JOIN asignatura_intencion ON asignatura.idmateria=asignatura_intencion.asignatura_idmateria where asignatura.materia='".$materia."')AS F1 inner join situacion on F1.situacion_idsituacion=situacion.idsituacion 
